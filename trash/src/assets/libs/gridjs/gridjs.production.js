!(function (t, e) {
    ...
    function w(t, e, n, r, i) {
        var o = { type: t, props: e, key: n, ref: r, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: null == i ? ++l.__v : i };
        ...
        for (var t; (N.__r = p.length); )
            (t = p.sort(function (t, e) {
                ...
                t.some(function (t) {
                    ...
                    t.__d &&
                        ((o = (i = (e = t).__v).__e),
                        (s = e.__P) && ((n = []), ((r = v({}, i)).__v = i.__v + 1), I(s, i, r, e.__n, void 0 !== s.ownerSVGElement, null != i.__h ? [o] : null, n, null == o ? S(i) : o, i.__h), U(n, i), i.__e != o && C(i)));
                });
    }
        ...
        for (n.__k = [], c = 0; c < e.length; c++)
            if (
                ...
                I(t, f, (h = h || _), i, o, s, a, u, l),
                    (d = f.__e),
                    (p = f.ref) && h.ref != p && (v || (v = []), h.ref && v.push(h.ref, null, f), v.push(p, f.__c || d, f)),
                    null != d
                        ? (null == g && (g = d),
                          "function" == typeof f.type && null != f.__k && f.__k === h.__k ? (f.__d = u = F(f, u, t)) : (u = T(t, f, h, y, d, u)),
                          l || "option" !== n.type ? "function" == typeof n.type && (n.__d = u) : (t.value = ""))
            ...
            t: if ("function" == typeof N) {
                if (
                    ...
                    n.__c
                        ...
                        : ("prototype" in N && N.prototype.render ? (e.__c = p = new N(w, C)) : ((e.__c = p = new k(w, C)), (p.constructor = N), (p.render = O)),
                          S && S.sub(p),
                          (p.props = w),
                          p.state || (p.state = {}),
                          (p.context = C),
                    ...
                    null != N.getDerivedStateFromProps && (p.__s == p.state && (p.__s = v({}, p.__s)), v(p.__s, N.getDerivedStateFromProps(w, p.__s))),
                    (f = p.props),
                    (d = p.state),
                    h)
                )
                    null == N.getDerivedStateFromProps && null != p.componentWillMount && p.componentWillMount(), null != p.componentDidMount && p.__h.push(p.componentDidMount);
                else {
                    if (
                        (null == N.getDerivedStateFromProps && w !== f && null != p.componentWillReceiveProps && p.componentWillReceiveProps(w, C),
                    ...
                    : (e.__e = (function (t, e, n, r, i, o, s, a) {
                          ...
                          if (null === d) h === f || (a && t.data === f) || (t.data = f);
                              ...
                              if (
                                  ...
                                  e.__k = [];
                              else if (((g = e.props.children), E(t, Array.isArray(g) ? g : [g], e, n, r, i && "foreignObject" !== d, o, s, t.firstChild, a), null != o)) for (g = o.length; g--; ) null != o[g] && y(o[g]);
                              a ||
                                  ("value" in f && void 0 !== (g = f.value) && (g !== t.value || ("progress" === d && !g)) && R(t, "value", g, h.value, !1),
            ...
            function e(e, n) {
                ...
                return (
                    e.enabled &&
                        ...
                        (i = e.server
                            ? new ut({ keyword: e.keyword, url: e.server.url, body: e.server.body })
                            : new tt({ keyword: e.keyword, columns: r.config.header && r.config.header.columns, ignoreHiddenColumns: e.ignoreHiddenColumns || void 0 === e.ignoreHiddenColumns, selector: e.selector })),
                        (r.searchProcessor = i),
    ...
    var dt = (function (t) {
        ...
        mt = (function (t) {
            function e(e, n) {
                var r;
                return ((r = t.call(this, e, n) || this).processor = void 0), (r.onUpdateFn = void 0), (r.setTotalFromTabularFn = void 0), (r.state = { limit: e.limit, page: e.page || 0, total: 0 }), r;
            }
            i(e, t);
            var r = e.prototype;
            return (
                (r.componentWillMount = function () {
                    ...
                    this.props.enabled &&
                        ...
                        this.props.server
                            ? ((t = new _t({ limit: this.state.limit, page: this.state.page, url: this.props.server.url, body: this.props.server.body })), this.config.pipeline.on("afterProcess", this.setTotalFromTabularFn))
                ...
                (r.renderPages = function () {
                    ...
                    return (
                        this.state.page + Math.floor(e / 2) >= this.pages && (n = e - (this.pages - this.state.page)),
                        b(
                            P,
                            null,
                            this.pages > e &&
                                ...
                                b(
                                    ...
                                    b("button", { tabIndex: -1, className: nt(et("spread"), this.config.className.paginationButton) }, "...")
                                ),
                ...
                (r.renderSummary = function () {
                    return b(
                        ...
                        this.props.summary &&
                            ...
                            b(
                                "div",
                                { role: "status", "aria-live": "polite", className: nt(et("summary"), this.config.className.paginationSummary), title: this._("pagination.navigate", this.state.page + 1, this.pages) },
                                this._("pagination.showing"),
                                " ",
                                b("b", null, this._("" + (this.state.page * this.state.limit + 1))),
                                " ",
                                this._("pagination.to"),
                                " ",
                                b("b", null, this._("" + Math.min((this.state.page + 1) * this.state.limit, this.state.total))),
                                " ",
            ...
            return (
                ...
                (s.setSort = function (t, e) {
                    for (var n, i = u(e || this.columns || []); !(n = i()).done; ) {
                        ...
                        o.columns && o.columns.length > 0 && (o.sort = { enabled: !1 }),
                            ...
                            o.sort ? "object" == typeof o.sort && (o.sort = r({ enabled: !0 }, o.sort)) : (o.sort = { enabled: !1 }),
                ...
                (s.populatePlugins = function (e, n) {
                    for (var i, o = u(n); !(i = o()).done; ) {
                        var s = i.value;
                        void 0 !== s.plugin && e.plugin.add(r({ id: s.id, props: {} }, s.plugin, { position: t.PluginPosition.Cell }));
                    }
                }),
                (o.fromColumns = function (t) {
                    for (var e, n = new o(), r = u(t); !(e = r()).done; ) {
                        var i = e.value;
                        if ("string" == typeof i || c(i)) n.columns.push({ name: i });
            ...
            return (
                (t.createFromUserConfig = function (t) {
                    ...
                    return (
                        ...
                        t.from && ((e = new St(this.tableElementToArray(t.from))), (t.from.style.display = "none")),
                        ...
                        : t.map(function (t) {
                              return e.map(function (e, n) {
                                  return void 0 !== e.data
                                      ...
                                      : e.id
                                      ? t[e.id]
                                      : (lt.error("Could not find the correct cell for column at position " + n + ".\n                          Make sure either 'id' or 'selector' is defined for all columns."), null);
                              });
                          });
                }),
                (r._process = function (t) {
        ...
        Mt = (function () {
            ...
            return (
                ...
                (e.defaultConfig = function () {
                    return { plugin: new pt(), dispatcher: new Pt(), tableRef: { current: null }, tempRef: { current: null }, width: "100%", height: "auto", autoWidth: !0, style: {}, className: {} };
                }),
                (e.fromUserConfig = function (n) {
                    var i = new e(n);
                    return (
                        (i._userConfig = n),
                        "boolean" == typeof n.sort && n.sort && i.assign({ sort: { multiColumn: !0 } }),
                        ...
                        i.plugin.add({ id: "search", position: t.PluginPosition.Header, component: ft, props: r({ enabled: !0 === n.search || n.search instanceof Object }, n.search) }),
                        i.plugin.add({ id: "pagination", position: t.PluginPosition.Footer, component: mt, props: r({ enabled: !0 === n.pagination || n.pagination instanceof Object }, n.pagination) }),
                        n.plugins &&
    ...
    var Ot,
        ...
        Bt = (function (t) {
            ...
            return (
                (n.content = function () {
                    return this.props.column && "function" == typeof this.props.column.formatter
                        ? this.props.column.formatter(this.props.cell.data, this.props.row, this.props.column)
                        : this.props.column && this.props.column.plugin
                        ? b(ht, { pluginId: this.props.column.id, props: { column: this.props.column, cell: this.props.cell, row: this.props.row } })
        ...
        zt = (function (t) {
            ...
            return (
                ...
                (n.render = function () {
                    return b("tr", { className: nt(et("tr"), this.config.className.tr), onClick: this.handleClick.bind(this) }, this.getChildren());
                }),
                e
            );
        })(G),
        qt = (function (t) {
            ...
            return (
                i(e, t),
                (e.prototype.render = function () {
                    return b(zt, { messageRow: !0 }, b(Bt, { role: "alert", colSpan: this.props.colSpan, messageCell: !0, cell: new V(this.props.message), className: nt(et("message"), this.props.className ? this.props.className : null) }));
                }),
                e
            );
        })(G),
                ...
                (n.render = function () {
                    ...
                    return b(
                        ...
                        this.props.status === Dt.Loading &&
                            ...
                            b(qt, { message: this._("loading"), colSpan: this.headerLength(), className: nt(et("loading"), this.config.className.loading) }),
                        this.props.status === Dt.Rendered &&
                            this.props.data &&
                            0 === this.props.data.length &&
                            b(qt, { message: this._("noRecordsFound"), colSpan: this.headerLength(), className: nt(et("notfound"), this.config.className.notfound) }),
                        this.props.status === Dt.Error && b(qt, { message: this._("error"), colSpan: this.headerLength(), className: nt(et("error"), this.config.className.error) })
                    );
                }),
                e
            );
            ...
            return (
                ...
                (n.sortColumn = function (t, e, n, r) {
                    var i = [].concat(this.state),
                        ...
                        c = !1;
                    if (
                        (void 0 !== s ? (n ? (-1 === s.direction ? (l = !0) : (c = !0)) : 1 === o ? (c = !0) : o > 1 && ((u = !0), (a = !0))) : 0 === o ? (a = !0) : o > 0 && !n ? ((a = !0), (u = !0)) : o > 0 && n && (a = !0),
                        u && (i = []),
                        a)
                    )
        ...
        Yt = (function (t) {
            function e(e, n) {
                ...
                return (
                    ...
                    e.enabled && ((r.sortProcessor = r.getOrCreateSortProcessor()), (r.updateStateFn = r.updateState.bind(s(r))), r.store.on("updated", r.updateStateFn), (r.state = { direction: 0 })),
                    r
                );
            }
            i(e, t);
                    ...
                    return (
                        n.length > 0
                            ...
                            : ((this.updateSortProcessorFn = this.updateSortProcessor.bind(this)),
                              ...
                              (e = t === K.ServerSort ? new Vt(r({ columns: this.store.state }, this.config.sort.server)) : new Xt({ columns: this.store.state })),
        ...
        Zt = (function (t) {
            ...
            return (
                ...
                (n.start = function (t) {
                    var e, n, r, i, o;
                    t.stopPropagation(),
                        this.setState({ offsetStart: parseInt(this.props.thRef.current.style.width, 10) - this.getPageX(t) }),
        ...
        Jt = (function (t) {
            ...
            return (
                ...
                (n.content = function () {
                    return void 0 !== this.props.column.name ? this.props.column.name : void 0 !== this.props.column.plugin ? b(ht, { pluginId: this.props.column.plugin.id, props: { column: this.props.column } }) : null;
                }),
                ...
                (n.render = function () {
                    ...
                    return (
                        ...
                        b(
                            ...
                            r(
                                {
                                    ...
                                    style: r({}, this.config.style.th, { minWidth: this.props.column.minWidth, width: this.props.column.width }, this.state.style, this.props.style),
                            ...
                            b("div", { className: et("th", "content") }, this.content()),
                            this.isSortable() && b(Yt, r({ ref: this.sortRef, index: this.props.index }, this.props.column.sort)),
                            this.isResizable() && this.props.index < this.config.header.visibleColumns.length - 1 && b(Zt, { column: this.props.column, thRef: this.thRef })
                        )
                    );
                }),
                e
        ...
        Qt = (function (t) {
            ...
            return (
                ...
                (n.render = function () {
                    return this.props.header ? b("thead", { key: this.props.header.id, className: nt(et("thead"), this.config.className.thead) }, this.renderRows()) : null;
                }),
                e
            );
        })(G),
        te = (function (t) {
            ...
            return (
                ...
                (e.prototype.render = function () {
                    return b(
                        "table",
                        { role: "grid", className: nt(et("table"), this.config.className.table), style: r({}, this.config.style.table, { height: this.props.height }) },
                        b(Qt, { header: this.props.header }),
                        b(Gt, { data: this.props.data, status: this.props.status, header: this.props.header })
                    );
                }),
                e
            );
        ...
        ee = (function (e) {
            ...
            return (
                ...
                (o.render = function () {
                    return this.state.isActive ? b("div", { ref: this.headerRef, className: nt(et("head"), this.config.className.header), style: r({}, this.config.style.header) }, b(ht, { position: t.PluginPosition.Header })) : null;
                }),
                n
            );
        })(G),
        ne = (function (e) {
            ...
            return (
                ...
                (o.render = function () {
                    return this.state.isActive ? b("div", { ref: this.footerRef, className: nt(et("footer"), this.config.className.footer), style: r({}, this.config.style.footer) }, b(ht, { position: t.PluginPosition.Footer })) : null;
                }),
                n
            );
        })(G),
        re = (function (t) {
            function e(e, n) {
                ...
                return (
                    ...
                    (r.state = { status: Dt.Loading, header: e.header, data: null }),
                    r
                );
            }
            i(e, t);
                ...
                (n.render = function () {
                    return b(
                        ...
                        b(
                            ...
                            this.state.status === Dt.Loading && b("div", { className: et("loading-bar") }),
                            b(ee, null),
                            b(
                                "div",
                                { className: et("wrapper"), style: { height: this.props.height } },
                                b(te, { ref: this.props.config.tableRef, data: this.state.data, header: this.state.header, width: this.props.width, height: this.props.height, status: this.state.status })
                            ),
                            b(ne, null),
                            b("div", { ref: this.props.config.tempRef, id: "gridjs-temp", className: et("temp") })
                        )
                    );
                }),
                e
        ...
        ie = (function (t) {
            function e(e) {
                var n;
                return ((n = t.call(this) || this).config = void 0), (n.plugin = void 0), (n.config = new Mt({ instance: s(n), eventEmitter: s(n) }).update(e)), (n.plugin = n.config.plugin), n;
            }
            i(e, t);
            var n = e.prototype;
            return (
                ...
                (n.createElement = function () {
                    return b(re, { config: this.config, pipeline: this.config.pipeline, header: this.config.header, width: this.config.width, height: this.config.height });
                }),
                (n.forceRender = function () {
                    return (
                        (this.config && this.config.container) || lt.error("Container is empty. Make sure you call render() before forceRender()", !0),
                ...
                (n.render = function (t) {
                    return (
                        ...
                        t.childNodes.length > 0 ? (lt.error("The container element " + t + " is not empty. Make sure the container is empty and call render() again"), this) : ((this.config.container = t), j(this.createElement(), t), this)
                    );
                }),
                e
            );
